...
**Key Features:**
- Abstract `Vehicle` superclass with `Cab` and `Bus` polymorphism
- O(1) vehicle lookup using `HashMap`
...
**Key Features:**
- Memory-based AI with state tracking
...
I'm always happy to connect with other students, developers and people working in tech. If you're interested in my projects or want to chat, feel free to reach out.
